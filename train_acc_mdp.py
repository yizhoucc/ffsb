...
from FireflyEnv import firefly_mdp, firefly_acc
...
# for i in range(5):
#     namestr= ("trained_agent/mdp_pretrain_tau_d_{}_{}_{}_{}_{}".format(train_time,i,
...
max_distance=1
for i in range(10):  
    namestr= ("trained_agent/mdp_noise_{}_{}_{}_{}_{}".format(train_time,i,
    str(time.localtime().tm_mday),str(time.localtime().tm_hour),str(time.localtime().tm_min)
    ))
