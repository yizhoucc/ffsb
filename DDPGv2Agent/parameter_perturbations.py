...
class ParameterNoise(object):
    ...
    def setup_param_noise(self, normalized_observation):
        ...
        self.set_perturbed_actor_updates(self.perturbed_actor) # add noise to parameters
    ...
    def adapt_param_noise(self, state):
        ...
        self.param_noise.adapt(adaptive_noise_distance) # change noise std based on distance
